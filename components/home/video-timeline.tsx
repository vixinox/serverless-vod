...
type TimelineVariant = "saved" | "watch-later" | "history";
...
> = {
  ...
  history: {
    heroClassName:
      "border-emerald-500/20 bg-[linear-gradient(135deg,rgba(16,185,129,0.16),rgba(20,184,166,0.08)_42%,rgba(132,204,22,0.12))]",
    glowClassName:
      "bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.24),transparent_42%),radial-gradient(circle_at_bottom_right,rgba(132,204,22,0.16),transparent_36%)]",
    dotClassName: "border-emerald-200/60 bg-emerald-400 shadow-[0_0_0_6px_rgba(16,185,129,0.12)]",
    railClassName: "bg-gradient-to-b from-emerald-300 via-teal-400 to-lime-400",
    activeItemClassName:
      "border-emerald-400/30 bg-emerald-500/12 text-foreground shadow-[0_16px_40px_-24px_rgba(16,185,129,0.52)]",
    activeDotClassName: "border-emerald-100 bg-emerald-300",
    badgeClassName:
      "border-emerald-500/20 bg-emerald-500/10 text-emerald-700 dark:text-emerald-200",
    panelClassName:
      "border-emerald-500/15 bg-[linear-gradient(180deg,rgba(236,253,245,0.92),rgba(255,255,255,0.72))] dark:bg-[linear-gradient(180deg,rgba(6,78,59,0.28),rgba(24,24,27,0.88))]",
    panelBarClassName: "bg-gradient-to-b from-emerald-300 via-teal-400 to-lime-400",
    panelGlowClassName:
      "bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.18),transparent_42%),radial-gradient(circle_at_bottom_right,rgba(132,204,22,0.12),transparent_35%)]",
  },
};
...
export function VideoTimeline({
  ...
  const groups = useMemo(() => groupTimelineVideos(videos, unit), [videos]);
  ...
  return (
    <div ref={rootRef} className="space-y-6">
      <div className="mt-3 space-y-2 px-2" data-home-animate>
      ...
      {groups.length > 0 ? (
        <div className="grid gap-6 xl:grid-cols-[16rem_minmax(0,1fr)]">
          <aside
            ...
            data-home-animate
          >
            <div className="sticky top-24 rounded-[2rem] p-5 shadow-[0_24px_60px_-48px_rgba(15,23,42,0.6)] backdrop-blur-xl">
          ...
          <div className="space-y-6">
            ...
            {groups.map((group) => (
              ...
              >
                <div
                  data-timeline-panel
                  className={"relative overflow-hidden rounded-[2rem] px-5 py-5"}
                >
